...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_CLIENT_ID, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_NPM13XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_NPM13XX_INIT_PRIORITY, 85);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ROM_END_OFFSET, 0x3096);
